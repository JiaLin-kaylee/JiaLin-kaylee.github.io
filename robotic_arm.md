...
2) They’re easy to recognize under varying lighting or angles because they store minimal data.
3) Used in robotics and 3D vision, and can be detected in Python with OpenCV and the apriltag library.
Sources:https://pyimagesearch.com/2020/11/02/apriltag-with-python/
...
After you get access to the PC, open up chrome and you will find a couple of uFactory tabs open. 
One of them has a bunch of block codes, they are quite silly, but you can also create your
own codes in Visual Studio Code. 
WARNING: YOU DON'T EXACTLY NEED TO KNOW HOW TO WRITE PYTHON, SOMETIMES WEBBGPT CAN DO IT FOR YOU! (me and thomas found it highly useful)
