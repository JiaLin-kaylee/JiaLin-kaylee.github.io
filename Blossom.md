...
# 🤖✨ **Project Journal Entry — Interactive ADHD‑Support Robot (Blossom‑Inspired)**

## **Project Overview**
I am building an interactive soft robot designed to support students and educators with attention deficit. The goal is to create a companion that provides grounding cues, emotional comfort, and gentle interaction through movement, texture, and sound. The robot is inspired by USC’s *Blossom* project, but I am adapting the design to focus specifically on ADHD‑supportive behaviors such as rhythmic breathing, soft tactile feedback, and subtle audio cues.

This robot is meant to feel alive, approachable, and calming — not overstimulating. Every design decision, from the crochet body to the motion curves, is centered on that intention.

---

## 🏗️ **Current Progress — Mechanical + Structural**
